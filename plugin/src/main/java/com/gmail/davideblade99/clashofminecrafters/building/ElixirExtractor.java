...
/**
 * Represents an elixir extractor
 *
 * @author DavideBlade
 * @since 3.2
 */
public final class ElixirExtractor {
    ...
    /**
     * Initializes a new elixir extractor, with the building delimited by the corners {@code corner1} and {@code corner2}
     *
     ...
     */
    public ElixirExtractor(final int level, @Nonnull final Vector corner1, @Nonnull final Vector corner2) {
        this(level, new Area(corner1, corner2));
    }

    /**
     * Initializes a new elixir extractor, with the building delimited by the specified area
     *
     * @param level        Extractor level
     ...
     * @throws IllegalArgumentException If the level is less than or equal to 0
     */
    public ElixirExtractor(final int level, @Nonnull final Area buildingArea) {
        if (level <= 0)
    ...
    /**
     * Sets the specified level for the elixir extractor
     *
