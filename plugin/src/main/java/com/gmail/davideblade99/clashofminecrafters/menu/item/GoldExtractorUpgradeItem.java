...
public final class GoldExtractorUpgradeItem extends UpgradeMenuItem {
     ...
     * {@inheritDoc}
     */
    public GoldExtractorUpgradeItem(@Nonnull final CoM plugin, @Nonnull final ConfiguredBuilding nextBuilding, final byte slot) {
    ...
    public void onClick(@Nonnull final CoM plugin, @Nonnull final Player clicker) {
        plugin.getUpgradeManager().upgradeGoldExtractor(clicker, clicker.getLocation());
    }
}
